...
urlpatterns = [
    ...
    path('<int:id_company>/<int:id_producto>/detail_product', views.optenerProducto, name='detail_product'),
    ...
    path('reproducir_video/<int:id_producto>', views.reproducir_video, name='reproducir_video'),
]